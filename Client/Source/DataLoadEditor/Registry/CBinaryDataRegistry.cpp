...
void CBinaryDataRegistry::CheckFiles(FString strFileName, const FFileStatData& StatData, int nExtentionIndex)
{
	//binary file
	...
	else
	{
		...
		strFileName += FPaths::GetBaseFilename(strFileName);
...
void CBinaryDataRegistry::CheckFilesDiff()
{
