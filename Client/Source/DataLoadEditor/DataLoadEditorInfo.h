...
class DATALOADEDITOR_API DataLoadEditorInfo
{
public:
	static const FString BYTE_EXTS;
	static const FString UASSET_EXTS;
	static const FString PATH_RELATIVE_BINARY_ROOT;
};