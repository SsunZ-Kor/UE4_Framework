...
UCLASS()
class CLIENT_API UActionEventRuntime_Animation : public UObject, public ActionEventRuntimeBase<FActionEventData_Animation>
{
	GENERATED_BODY()
private:
...
public:
	...
	virtual void Init(FActionEventData_Animation& data, AGameCharacter* owner, UActionData*pActionLength) override;
