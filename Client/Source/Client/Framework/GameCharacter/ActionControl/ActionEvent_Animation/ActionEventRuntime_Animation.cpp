...
void UActionEventRuntime_Animation::Init(FActionEventData_Animation& Data, AGameCharacter* Owner, UActionData*pActionLength)
{
	ActionEventRuntimeBase<FActionEventData_Animation>::Init(Data, Owner, pActionLength);
