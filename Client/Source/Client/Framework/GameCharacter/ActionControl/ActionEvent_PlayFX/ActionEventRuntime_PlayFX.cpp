...
void UActionEventRuntime_PlayFX::Init(FActionEventData_PlayFX& Data, AGameCharacter* Owner, UActionData*pActionLength)
{
	ActionEventRuntimeBase<FActionEventData_PlayFX>::Init(Data, Owner, pActionLength);
