...
void UActionEventRuntime_Rotate::Init(FActionEventData_Rotate& Data, AGameCharacter* Owner, UActionData*pActionLength)
{
	ActionEventDurationRuntimeBase<FActionEventData_Rotate>::Init(Data, Owner, pActionLength);
