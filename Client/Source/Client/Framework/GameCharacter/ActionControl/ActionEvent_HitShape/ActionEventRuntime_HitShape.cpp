...
void UActionEventRuntime_HitShape::Init(FActionEventData_HitShape& Data, AGameCharacter* Owner, UActionData*pActionLength)
{
	ActionEventRuntimeBase<FActionEventData_HitShape>::Init(Data, Owner, pActionLength);
