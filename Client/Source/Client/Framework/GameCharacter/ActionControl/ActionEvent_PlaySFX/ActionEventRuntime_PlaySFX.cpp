...
#include "Client/Framework/Managers/SFXManager/SFXManager.h"
...
void UActionEventRuntime_PlaySFX::Init(FActionEventData_PlaySFX& Data, AGameCharacter* Owner, UActionData*pActionLength)
{
	ActionEventRuntimeBase<FActionEventData_PlaySFX>::Init(Data, Owner, pActionLength);
