...
UCLASS()
class CLIENT_API UActionEventRuntime_PlaySFX : public UObject, public ActionEventRuntimeBase<FActionEventData_PlaySFX>
{
	GENERATED_BODY()
...
public:
	...
	virtual void Init(FActionEventData_PlaySFX& data, AGameCharacter* owner, UActionData*pActionLength) override;
