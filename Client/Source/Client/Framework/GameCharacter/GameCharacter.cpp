...
const CCharacterData* AGameCharacter::GetData()
{
	return m_Data;
}
...
void AGameCharacter::Hit(AGameCharacter* pAttacker, const FVector& hitPoint, const FQuat& hitNormal, USoundBase* hitSFX, UFXContainer* hitFX)
{
	//TODO
