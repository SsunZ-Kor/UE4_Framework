...
struct SModuleInfo
{
	...
	SModuleInfo(TDoubleLinkedListEx<UUIModuleBase*>::TDoubleLinkedListExNode* node, UCanvasPanel* parent, FVector2D location);
};

UCLASS()
class CLIENT_API UWindowBase : public UImmortalWidget
{
	GENERATED_BODY()
...
private: // For UIModule
	...
	TDoubleLinkedListEx<UUIModuleBase*> m_llist_ModuleStack;
	TMap<UClass*, SModuleInfo> m_map_ModuleStackNode;
...
public: // For Window Stack
	...
	*/
	 ...
	 */
	virtual void OnWindowOpened(const bool& bOpen, const int32& zOrder);
